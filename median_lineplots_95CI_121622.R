...
ggsave(paste0("medianPropCNV_noBars_121622_8x16.png"), bg = "#FFFFFF", height = 8, width = 16)
ggsave(paste0("medianPropCNV_noBars_121622_8x16.pdf"), bg = "#FFFFFF", height = 8, width = 16)
ggsave(paste0("medianPropCNV_95CI_121622_8x16.png"), bg = "#FFFFFF", height = 8, width = 16)
ggsave(paste0("medianPropCNV_95CI_121622_8x16.pdf"), bg = "#FFFFFF", height = 8, width = 16)
